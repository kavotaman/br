...
Bach, _Suite para Violoncelo Solo No. 4_ - 2016

{% include youtube.html video="l-Nn0cI9k1I" %}

Cassadó, _Suite para Violoncelo Solo_ - 2017

{% include youtube.html video="E_lrMEASAYU" %}

Lutoslawski, _Variações Sacher_ - 2018

{% include youtube.html video="h3ZpIxjfWjU" %}

Alexandre Guilherme, _For Otamaka_ - 2020

{% include youtube.html video="B4ZDorm8QOQ" %}

Fajiolli de Oliveira, _Recitativo_ - 2020
...
Brahms, _Sonata para Violoncelo e Piano Op. 99 No. 2_ - 2016

{% include youtube.html video="EDHxhVr_CSA" %}

Beethoven, _Sonata para Piano e Violoncelo No. 3_ - 2016

{% include youtube.html video="zsYzRToXTbU" %}

Dvorak, _Concerto para Violoncelo_ - 2016

{% include youtube.html video="QgLoj2HcatY" %}

Prokofiev, _Sinfonia Concertante_ - 2017

{% include youtube.html video="_ay676h6E3w" %}

Beethoven, _7 Variações_ - 2017

{% include youtube.html video="intMx-sIKWs" %}

Recital de Mestrado - 2019

{% include youtube.html video="9IuPxT0Afz4" %}

Schubert, _Sonata para Arpeggione_ - 2020

{% include youtube.html video="KCc_Ll9am6E" %}

Faure, _Apres un Reve_ - 2020

{% include youtube.html video="ENSOZHyFV1c" %}

Tchaikovsky, _Variações Rococó_ - 2020
...
Schubert, _"A Morte e a Donzela"_ - 2016
...
Mozart, _Quarteto das Dissonâncias_ - 2016
...
David T Little, _Musik für den Schultheiß_ - 2018
...
Haydn, _Op. 50 No. 4_ - 2018

{% include youtube.html video="zVMorZaqT80" %}

Beethoven, _Op. 95_ - 2019

{% include youtube.html video="BIztWeXUXxE" %}

Shostakovich, _No. 3_ - 2019

{% include youtube.html video="sqW4F0tJdmc" %}

### Quinteto

_Por Una Cabeza_ e _Mourão_ - 2015

{% include youtube.html video="Q0yc40AKSLs" %}

Schubert, _Quinteto de Cordas_ - 2017

{% include youtube.html video="GGuZmDgS1YY" %}

### Grupo de Violoncelos

Villa-Lobos, _Bachianas Brasileiras No. 5_ - 2016

{% include youtube.html video="_aMDMfyuwy4" %}

_Tema dos Simpsons_ - 2018

{% include youtube.html video="KHYz0p-5Agk" %}

_Things Left Unsaid_ - 2018

{% include youtube.html video="ejOFSYPxNsw" %}

### Grupos Mistos

Debussy, _Afternoon of a Faun_ - 2017

{% include youtube.html video="RpZQU3PufmA" %}

Kernis, _On Distant Shores_ - 2018

{% include youtube.html video="x8FSYWrmQDE" %}

Steven Mackey, _Micro-Concerto_ - 2018

{% include youtube.html video="a-5yY1dC5Bo" %}

Augusta Read Thomas, _Selene_, para quarteto de cordas e quarteto de percussão - 2019

{% include youtube.html video="mtCQNYUXqos" %}

Adam Har-Zvi, Micro Opera _The Wanderer, the Guide, and the Beasts of the Mind_ - 2019

{% include youtube.html video="_hp9MYHjAjQ" %}

Emily McPherson, _Ebb_, para soprano, clarinete, violino, violoncelo e piano - 2020

{% include youtube.html video="NS9LWCKuD3k" %}

Adam Har-Zvi, _Meshuga_, para flauta, clarinete, violoncelo e contrabaixo - 2020

{% include youtube.html video="iUEO1vGFKqI" %}

## Orquestra

Grieg, _Suite Holberg_ - 2011

{% include youtube.html video="6suKD3b9unA" %}

{% include youtube.html video="MWpMP0shiws" %}

_I Could Have Danced All Night_ - 2015

{% include youtube.html video="MqtqsxTVHf4" %}

Dvorak, _Serenata para Cordas_ - 2017

{% include youtube.html video="es_vfK7E2qc" %}

Tchaikovsky, _Serenata para Cordas_ - 2017

{% include youtube.html video="9QSyhGypp3M" %}

## Doideras do Távio

_Ode ao Barulho No.2_, pra qualquer combinação de instrumentos de cordas - 2019

{% include youtube.html video="v4fNAgwaoQs" %}

_O Outro, ou como descascar uma banana_ - 2020

{% include youtube.html video="0wr2DRr0F6I" %}

## Popular

_Tico-Tico no Fubá_ (Capão Bonito) - 2012

{% include youtube.html video="lH5A1PrhyxE" %}

Flávio, Cris e Otávio no Casarão - 2018

{% include youtube.html video="ZOg3rWaxrDA&list=PL989LlpyKacdzvNgjulvwf3F9A-bBzWim" %}

Tom Jobim, _Retrato em Preto e Branco_, com a Cris - 2019

{% include youtube.html video="WJKKqWzXZ3Q" %}

## Macabration

Helloween, _I Want Out_ - 2004

{% include youtube.html video="0alN4IqBuF8" %}

Iron Maiden, _Aces High_ - 2008

{% include youtube.html video="QK-dOW7ul9w" %}

Iron Maiden, _Be Quick or Be Dead_ - 2008

{% include youtube.html video="vcDW_WqGflQ" %}

Hermes e Renato, _Airton Senna_ - 2009

{% include youtube.html video="wCSFv_tt2NI" %}

The Beatles, _Torta de Mel Silvestre_ - 2018

{% include youtube.html video="YVdnyqwQlZ4" %}

### Fantoches

Wassilyto e Seus Amigos - 2018

{% include youtube.html video="1nUykWXIYf8" %}

Skolta 121, _Brasil Global_ - 2018

{% include youtube.html video="DwV3jcydYwU" %}

Iron Maiden, _The Trooper_ - 2018

{% include youtube.html video="W1emjJsZv30" %}

The Beatles, _I'm Down_ - 2018
